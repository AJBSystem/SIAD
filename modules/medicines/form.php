...
<div class="col-md-4">
  <label for="exampleInputEmail1">Estado</label>
    <select type="text" class="form-control" name="estado" autocomplete="off" value="<?php echo $data['estado']; ?>">
      <option>Amazonas</option>
        <option>Anzoategui</option>
          <option>Apure</option>
            <option>Aragua</option>
  ...
  <div class="col-md-4">
    <label for="exampleInputEmail1">Municipio</label>
      <input type="text" class="form-control" name="municipio" autocomplete="off" value="<?php echo $data['municipio']; ?>">
  </div> 

    <div class="col-md-4">
      <label for="exampleInputEmail1">Ciudad</label>
        <input type="text" class="form-control" name="ciudad" autocomplete="off" value="<?php echo $data['ciudad']; ?>">
    </div>

      <div class="col-md-4">
        <label for="exampleInputEmail1">Parroquia</label>
          <input type="text" class="form-control" name="parroquia" autocomplete="off" value="<?php echo $data['parroquia']; ?>">
      </div>

        <div class="col-md-4">
          <label for="exampleInputEmail1">Avenida</label>
            <input type="text" class="form-control" name="avenida" autocomplete="off" value="<?php echo $data['avenida']; ?>">
        </div>

          <div class="col-md-4">
            <label for="exampleInputEmail1">Calle</label>
              <input type="text" class="form-control" name="calle" autocomplete="off" value="<?php echo $data['calle']; ?>">
          </div>

            <div class="col-md-4">
              <label for="exampleInputEmail1">Casa N°</label>
                <input type="text" class="form-control" name="casa" autocomplete="off" value="<?php echo $data['casa']; ?>">
            </div>
...
<div class="col-md-2">
  ...
  <div class="col-md-2">
    ...
    <div class="col-md-2">
      <label for="exampleInputEmail1">Discapacidad</label>
        <input type="text" class="form-control" name="discapacidad" autocomplete="off" value="<?php echo $data['discapacidad']; ?>">
    </div>

      <div class="col-md-2">
        <label for="exampleInputEmail1">Alergias</label>
          <input type="text" class="form-control" name="alergias" autocomplete="off" value="<?php echo $data['alergias']; ?>">
      </div>

        <div class="col-md-2">
          <label for="exampleInputEmail1">Notas</label>
            <input type="text" class="form-control" name="notas" autocomplete="off" value="<?php echo $data['notas']; ?>">
        </div>
</div>
    ...
    <div class="col-md-2">
      ...
      <div class="col-md-2">
        ...
        <div class="col-md-2">
          ...
          <div class="col-md-2">
            <label for="exampleInputEmail1">Fecha de Nacimiento</label>
              <input type="date" class="form-control" name="fec_nacf" autocomplete="off" value="<?php echo $data['fec_nacf']; ?>">
          </div>

            <div class="col-md-2">
              <label for="exampleInputEmail1">Edad</label>
                <input type="text" class="form-control" name="edadf" autocomplete="off" value="<?php echo $data['edadf']; ?>">
            </div>
                    ...
                    <div class="col-md-1">
                      ...
                      <div class="col-md-2">
                        <label for="exampleInputEmail1">Informacion Medica</label>
                          <input type="text" class="form-control" name="inf_medf" autocomplete="off" value="<?php echo $data['inf_medf']; ?>">
                      </div>
