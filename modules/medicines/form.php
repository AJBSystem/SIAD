        ...
        <div class="box box-primary">
          ...
          <form role="form" class="form-horizontal" action="modules/medicines/proses.php?act=insert" method="POST">
            <div class="box-body">
              ...
              $query_id = mysqli_query($mysqli, "SELECT RIGHT(codigo,6) as cedula FROM funcionarios
