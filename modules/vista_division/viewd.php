...
<div class="btn-group pull-right"><a href="pdf/reporte_division.php">
  <button type='button'class="btn btn-primary" data-toggle="modal">
    <span class="glyphicon glyphicon-print" ></span> Imprimirpsh</button></a>
</div>
  ...
  <thead>
    <tr>
      <th class="center">No.</th>
        <th class="center">Nombre de lgga División</th>
