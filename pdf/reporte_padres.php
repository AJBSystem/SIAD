<?php
  ...
  $pdf->Cell(40,7,utf8_decode('Cedula del padre'),1,0,'C',1);
  ...
  $pdf->Cell(27,7,utf8_decode('Parentesco'),1,0,'C',1);
  $pdf->Cell(30,7,utf8_decode('Funcionario'),1,0,'C',1);
  $pdf->Cell(45,7,utf8_decode('Información Médica'),1,1,'C',1);
  ...
  while ( $row = $resultado->fetch_assoc() )
  {
   ...
   $pdf->Cell(72,7,utf8_decode($row['p_apellido']),1,0,'C',0); 
   ...
   $pdf->Cell(27,7,utf8_decode($row['parentesco']),1,0,'C',0);
   $pdf->Cell(30,7,utf8_decode($row['funcionario']),1,0,'C',0);     
   $pdf->Cell(45,7,utf8_decode($row['inf_medf']),1,1,'C',0);  
