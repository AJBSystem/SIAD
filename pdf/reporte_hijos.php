<?php
  ...
  $pdf->Cell(55,7,utf8_decode('Primer Nombre del Hijo'),1,0,'C',1);
  $pdf->Cell(55,7,utf8_decode('Segundo Nombre'),1,0,'C',1);
  $pdf->Cell(55,7,utf8_decode('Primer Apellido del Hijo'),1,0,'C',1);
  ...
  $pdf->Cell(30,7,utf8_decode('Estudiante'),1,0,'C',1);
  $pdf->Cell(30,7,utf8_decode('Funcionario'),1,0,'C',1);
  $pdf->Cell(55,7,utf8_decode('Información Médica'),1,1,'C',1);
  ...
  while ( $row = $resultado->fetch_assoc() )
  {
   ...
   $pdf->Cell(40,7,utf8_decode($row['s_nombre']),1,0,'C',0);
   ...
   $pdf->Cell(30,7,utf8_decode($row['edadf']),1,0,'C',0); 
   $pdf->Cell(30,7,utf8_decode($row['generof']),1,0,'C',0); 
   $pdf->Cell(30,7,utf8_decode($row['estudiante']),1,0,'C',0); 
   $pdf->Cell(30,7,utf8_decode($row['funcionario']),1,0,'C',0);     
   $pdf->Cell(55,7,utf8_decode($row['inf_medf']),1,1,'C',0);  
